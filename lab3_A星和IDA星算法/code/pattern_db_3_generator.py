...
def static_additive_disjoint_pattern_database():
    '''
    pretrain the data. use backward BFS from the goal state to every case to build the position-distance dictionary
    '''
    ...
    try:
        ...
        file_name = ['pattern_database_3_1.pkl', 'pattern_database_3_2.pkl', 'pattern_database_3_3.pkl']
        from copy import deepcopy

        n = 4

        subset_1_goalstate = {'values': [1, 2, 5, 6, 9],
                              'goalstate': [[1, 2, -1, -1],
                                            [5, 6, -1, -1],
                                            [9, -1, -1, -1],
                                            [-1, -1, -1, 0]],
        ...
        K= -1
        for subset in [subset_1_goalstate]: # for each of the subsets
            K += 1
            # BFS process
