#coding=gbk
'''
this file is used to calculate the pattern database of 3 subsets, previously calculated distances are stored in the data dictionaries.
you can check them in the pattern_database_3_1.pkl file and so on.
